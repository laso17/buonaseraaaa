...
a) How many unique astronauts are stored in the data set? 565

```{r}
# YOUR CODE HERE

```
taking a look at the dataset I can see that the variable number already provides me with the number of astronauts, without duplicates, which is 565
