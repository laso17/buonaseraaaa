...
a) How many unique astronauts are stored in the data set? 564

```{r}
# YOUR CODE HERE
max(astronauts$number)
...
distinct(astronauts, name, .keep_all = TRUE)
astro_gender <- distinct(astronauts, name, .keep_all = TRUE)
sum(astro_gender$sex == "female")

distinct(astronauts, name, .keep_all = TRUE)
astro_nation <- distinct(astronauts, name, .keep_all = TRUE)
sum(astro_nation$nationality == "U.S.")
```
